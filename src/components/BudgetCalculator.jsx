...
import { Calculator, Plus, Trash2, Package, Bed, Plane, Car, Shield, GraduationCap, Ticket, Wallet, Loader2, Bus } from "lucide-react";
...
const CATEGORIES = [
  ...
  { value: "transfers", label: "העברות", icon: Bus, color: "text-fuchsia-600", bg: "bg-fuchsia-50" },
