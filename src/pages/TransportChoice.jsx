...
export default function TransportChoice() {
  ...
  const loadTrip = async () => {
    ...
    if (guestMode) {
      const migrated = await transitionGuestToUser(navigate, 'TransportChoice');
      if (migrated) return;
    }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6 flex items-center justify-center" role="status" aria-busy="true" aria-label="טוען">
